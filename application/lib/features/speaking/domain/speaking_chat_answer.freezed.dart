...
@override
int get hashCode => Object.hash(runtimeType,id,detailId,const DeepCollectionEquality().hash(utterances),createdAt,const DeepCollectionEquality().hash(topics),duration,isGraded,testTask,coherenceScore,lexicalScore,grammaticalScore,fluencyScore,bandScore,coherenceFeedback,lexicalFeedback,grammaticalFeedback);

@override
String toString() {
  return 'SpeakingChatAnswer(id: $id, detailId: $detailId, utterances: $utterances, createdAt: $createdAt, topics: $topics, duration: $duration, isGraded: $isGraded, testTask: $testTask, coherenceScore: $coherenceScore, lexicalScore: $lexicalScore, grammaticalScore: $grammaticalScore, fluencyScore: $fluencyScore, bandScore: $bandScore, coherenceFeedback: $coherenceFeedback, lexicalFeedback: $lexicalFeedback, grammaticalFeedback: $grammaticalFeedback)';
}
...
class _SpeakingChatAnswer implements SpeakingChatAnswer {
  const _SpeakingChatAnswer({this.id, this.detailId, required final  List<SpeakingUtteranceVO> utterances, required this.createdAt, required final  List<PromptTopic> topics, required this.duration, required this.isGraded, required this.testTask, this.coherenceScore, this.lexicalScore, this.grammaticalScore, this.fluencyScore, this.bandScore, this.coherenceFeedback, this.lexicalFeedback, this.grammaticalFeedback}): _utterances = utterances,_topics = topics;
...
@override
int get hashCode => Object.hash(runtimeType,id,detailId,const DeepCollectionEquality().hash(_utterances),createdAt,const DeepCollectionEquality().hash(_topics),duration,isGraded,testTask,coherenceScore,lexicalScore,grammaticalScore,fluencyScore,bandScore,coherenceFeedback,lexicalFeedback,grammaticalFeedback);
